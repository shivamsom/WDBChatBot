...
namespace WDB { 
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            addOutMessage("Hello! How may I help you ?");
        ...
        private void showOutput()
        {
            ...
            {
                SoundPlayer Send = new SoundPlayer(Environment.CurrentDirectory+@"\SOUND1.wav"); // Send Sound Effect
                SoundPlayer Rcv = new SoundPlayer(Environment.CurrentDirectory+@"\SOUND2.wav"); // Recieve Sound Effect
                ...
                string outtt = bot.getOutput(InputTxt.Text); //goood ebvening
